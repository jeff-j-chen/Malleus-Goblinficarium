...
inline RectTransform_t6C5DA5E41A89E0F488B001E45E58963480E543A5* GameObject_AddComponent_TisRectTransform_t6C5DA5E41A89E0F488B001E45E58963480E543A5_m771EB78FF8813B5AFF21AC0D252E5461943E6388 (GameObject_t76FEDD663AB33C991A9C9A23129337651094216F* __this, const RuntimeMethod* method)
{
	...
	return (RectTransform_t6C5DA5E41A89E0F488B001E45E58963480E543A5*)il2cppRetVal;
}
...
IL_002e:
	{
		...
		NullCheck(L_5);
		UnityAction_t11A1F3B953B365C072A5DCC32677EE1796A962A7* L_6 = ((Graphic_tCBFCA4585A19E2B75465AECFEAC43F4016BF7931*)L_5)->___m_OnDirtyVertsCallback_18;
		if (!L_6)
		{
			goto IL_004e;
		}
	}
	{
		...
		NullCheck(L_8);
		UnityAction_Invoke_m5CB9EE17CCDF64D00DE5D96DF3553CDB20D66F70(L_8, NULL);
	}
...
IL_002e:
	{
		...
		TextMeshProUGUI_t101091AF4B578BB534C92E9D1EEAF0611636D957* L_4 = V_1;
		NullCheck(L_4);
		((TMP_Text_tE8D677872D43AD4B2AAF0D6101692A17D0B251A9*)L_4)->___m_isMaterialDirty_52 = (bool)1;
		// CanvasUpdateRegistry.RegisterCanvasElementForGraphicRebuild(this);
		TextMeshProUGUI_t101091AF4B578BB534C92E9D1EEAF0611636D957* L_5 = V_1;
		il2cpp_codegen_runtime_class_init_inline(CanvasUpdateRegistry_t7A4CC63D880F418DCDE83152B6FDB3259DF14DD1_il2cpp_TypeInfo_var);
		CanvasUpdateRegistry_RegisterCanvasElementForGraphicRebuild_mFBE1BDEA23FD40125CADE103F1BBBAFD25895B64(L_5, NULL);
		// if (m_OnDirtyMaterialCallback != null)
		TextMeshProUGUI_t101091AF4B578BB534C92E9D1EEAF0611636D957* L_6 = V_1;
		NullCheck(L_6);
		UnityAction_t11A1F3B953B365C072A5DCC32677EE1796A962A7* L_7 = ((Graphic_tCBFCA4585A19E2B75465AECFEAC43F4016BF7931*)L_6)->___m_OnDirtyMaterialCallback_19;
		if (!L_7)
		{
			goto IL_0055;
		}
	}
	{
		...
		NullCheck(L_9);
		UnityAction_Invoke_m5CB9EE17CCDF64D00DE5D96DF3553CDB20D66F70(L_9, NULL);
	}
...
{
	{
		...
		bool L_2;
		L_2 = Rect_op_Inequality_m4698BE8DFFC2C4F79B03116FC33FE1BE823A8945(L_0, L_1, NULL);
		if (!L_2)
		{
			goto IL_0022;
		}
...
{
	{
		...
		bool L_2;
		L_2 = Vector4_op_Inequality_m23600308603A706A9DD6057603DEA82E9A6F9FEF_inline(L_0, L_1, NULL);
		if (!L_2)
		{
			goto IL_0022;
		}
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void TextContainer_Awake_m450AB495666750B5B2B9C20639C44C894F179B95 (TextContainer_t949A6EBEE5C8832723E73D8D3DCF4C8D0B3D7F3C* __this, const RuntimeMethod* method)
{
	...
	}
	{
		...
		String_t* L_2;
		L_2 = String_Concat_m9B13B47FCB3DF61144D9647DDA05F527377251B0(_stringLiteral946FB31E64428806FAC87AE3AD1D1DDD0431F94B, L_1, _stringLiteral77A4D95C5A66881369906720C24690D7097D85DC, NULL);
		il2cpp_codegen_runtime_class_init_inline(Debug_t8394C7EEAECA3689C2C9B9DE9C7166D73596276F_il2cpp_TypeInfo_var);
		Debug_LogWarning_m5C8299150E64600CBF5C92706AD610C21D0C0DC5(L_2, __this, NULL);
		// return;
		return;
	}
}
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void TextContainer_UpdateCorners_m3223B7904DD32545705F9B24FA52E13F8F198026 (TextContainer_t949A6EBEE5C8832723E73D8D3DCF4C8D0B3D7F3C* __this, const RuntimeMethod* method)
{
	...
	}
	{
		...
		Vector3__ctor_m5F87930F9B0828E5652E2D9D01ED907C01122C86_inline((&L_9), ((float)il2cpp_codegen_multiply((float)((-L_2)), (float)L_4)), ((float)il2cpp_codegen_multiply((float)((-L_6)), (float)L_8)), /*hidden argument*/NULL);
		NullCheck(L_0);
		...
		Vector3__ctor_m5F87930F9B0828E5652E2D9D01ED907C01122C86_inline((&L_19), ((float)il2cpp_codegen_multiply((float)((-L_12)), (float)L_14)), ((float)il2cpp_codegen_multiply((float)((float)il2cpp_codegen_subtract((float)(1.0f), (float)L_16)), (float)L_18)), /*hidden argument*/NULL);
		NullCheck(L_10);
		...
		Vector3__ctor_m5F87930F9B0828E5652E2D9D01ED907C01122C86_inline((&L_29), ((float)il2cpp_codegen_multiply((float)((float)il2cpp_codegen_subtract((float)(1.0f), (float)L_22)), (float)L_24)), ((float)il2cpp_codegen_multiply((float)((float)il2cpp_codegen_subtract((float)(1.0f), (float)L_26)), (float)L_28)), /*hidden argument*/NULL);
		NullCheck(L_20);
		...
		Vector3__ctor_m5F87930F9B0828E5652E2D9D01ED907C01122C86_inline((&L_39), ((float)il2cpp_codegen_multiply((float)((float)il2cpp_codegen_subtract((float)(1.0f), (float)L_32)), (float)L_34)), ((float)il2cpp_codegen_multiply((float)((-L_36)), (float)L_38)), /*hidden argument*/NULL);
		NullCheck(L_30);
...
IL_0019:
	{
		...
		bool L_5;
		L_5 = Vector2_op_Equality_m5447BF12C18339431AB8AF02FA463C543D88D463_inline(L_3, L_4, NULL);
		if (!L_5)
		{
			goto IL_0032;
		}
...
IL_004b:
	{
		...
		bool L_11;
		L_11 = Vector2_op_Equality_m5447BF12C18339431AB8AF02FA463C543D88D463_inline(L_9, L_10, NULL);
		if (!L_11)
		{
			goto IL_0064;
		}
...
IL_007d:
	{
		...
		bool L_17;
		L_17 = Vector2_op_Equality_m5447BF12C18339431AB8AF02FA463C543D88D463_inline(L_15, L_16, NULL);
		if (!L_17)
		{
			goto IL_0096;
		}
...
IL_0096:
	{
		...
		bool L_20;
		L_20 = Vector2_op_Equality_m5447BF12C18339431AB8AF02FA463C543D88D463_inline(L_18, L_19, NULL);
		if (!L_20)
		{
			goto IL_00af;
		}
...
IL_00c8:
	{
		...
		bool L_26;
		L_26 = Vector2_op_Equality_m5447BF12C18339431AB8AF02FA463C543D88D463_inline(L_24, L_25, NULL);
		if (!L_26)
		{
			goto IL_00e1;
		}
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void TextContainer__cctor_mD63F260799545A3AC56E52AD5DA29EB2026DD19C (const RuntimeMethod* method)
{
	static bool s_Il2CppMethodInitialized;
	if (!s_Il2CppMethodInitialized)
	{
...
IL2CPP_EXTERN_C void Frame_tE254B3BDA010B9114EF1F470C177342FAF3E8FFD_marshal_pinvoke_back(const Frame_tE254B3BDA010B9114EF1F470C177342FAF3E8FFD_marshaled_pinvoke& marshaled, Frame_tE254B3BDA010B9114EF1F470C177342FAF3E8FFD& unmarshaled)
{
	...
	SpriteFrame_t0AD908328349FA1B90D428FEBAAD7B480B6D59F4 unmarshaled_frame_temp_1;
	memset((&unmarshaled_frame_temp_1), 0, sizeof(unmarshaled_frame_temp_1));
	unmarshaled_frame_temp_1 = marshaled.___frame_1;
	unmarshaled.___frame_1 = unmarshaled_frame_temp_1;
	bool unmarshaled_rotated_temp_2 = false;
	unmarshaled_rotated_temp_2 = static_cast<bool>(marshaled.___rotated_2);
	unmarshaled.___rotated_2 = unmarshaled_rotated_temp_2;
	bool unmarshaled_trimmed_temp_3 = false;
	unmarshaled_trimmed_temp_3 = static_cast<bool>(marshaled.___trimmed_3);
	unmarshaled.___trimmed_3 = unmarshaled_trimmed_temp_3;
	SpriteFrame_t0AD908328349FA1B90D428FEBAAD7B480B6D59F4 unmarshaled_spriteSourceSize_temp_4;
	...
	unmarshaled.___spriteSourceSize_4 = unmarshaled_spriteSourceSize_temp_4;
	SpriteSize_tF99BB7603AE2E6587E6184ACAB6CD209FE6569B3 unmarshaled_sourceSize_temp_5;
	...
	unmarshaled.___sourceSize_5 = unmarshaled_sourceSize_temp_5;
	Vector2_t1FD6F485C871E832B347AB2DC8CBA08B739D8DF7 unmarshaled_pivot_temp_6;
	memset((&unmarshaled_pivot_temp_6), 0, sizeof(unmarshaled_pivot_temp_6));
	unmarshaled_pivot_temp_6 = marshaled.___pivot_6;
	unmarshaled.___pivot_6 = unmarshaled_pivot_temp_6;
}
